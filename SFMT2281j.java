 ...
 * </dl>
 */
public class SFMT2281j {
    
    private static final int MEXP = 2281;
    private static final int N = MEXP / 128 + 1;
    private static final int N32 = N * 4;
    private static final int POS1 = 12;
    private static final int SL1 = 19;
    private static final int SL2 = 1;
    private static final int SR1 = 5;
    private static final int SR2 = 1;
    private static final int MSK1 = 0xbff7ffbf;
    private static final int MSK2 = 0xfdfffffe;
    private static final int MSK3 = 0xf7ffef7f;
    private static final int MSK4 = 0xf2f7cbbf;
    ...
    private static final int PARITY4 = 0x41dfa600;
     ...
     * @throws NullPointerException if {@code jumpPoly == null}
     */
    public SFMT2281j copyAndJump(JumpPolynomial jumpPoly) {
        SFMT2281j r = new SFMT2281j(this);
        r.jump(jumpPoly);
        return r;
    }
