...
public class SFMT607j {
     ...
     * @throws NullPointerException if {@code jumpPoly == null}
     */
    public SFMT607j copyAndJump(JumpPolynomial jumpPoly) {
        SFMT607j r = new SFMT607j(this);
        r.jump(jumpPoly);
        return r;
    }
