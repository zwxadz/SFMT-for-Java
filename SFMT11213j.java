 ...
 * </dl>
 */
public class SFMT11213j {
    
    private static final int MEXP = 11213;
    private static final int N = MEXP / 128 + 1;
    private static final int N32 = N * 4;
    private static final int POS1 = 68;
    private static final int SL1 = 14;
    private static final int SL2 = 3;
    private static final int SR1 = 7;
    private static final int SR2 = 3;
    private static final int MSK1 = 0xeffff7fb;
    private static final int MSK2 = 0xffffffef;
    private static final int MSK3 = 0xdfdfbfff;
    private static final int MSK4 = 0x7fffdbfd;
    private static final int PARITY1 = 0x00000001;
    private static final int PARITY2 = 0x00000000;
    private static final int PARITY3 = 0xe8148000;
    private static final int PARITY4 = 0xd0c7afa3;
    ...
    private SFMT11213j(SFMT11213j r) {
     ...
     * @throws NullPointerException if {@code jumpPoly == null}
     */
    public SFMT11213j copyAndJump(JumpPolynomial jumpPoly) {
        SFMT11213j r = new SFMT11213j(this);
        r.jump(jumpPoly);
        return r;
    }
