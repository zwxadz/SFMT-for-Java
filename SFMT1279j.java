 ...
 * </dl>
 */
public class SFMT1279j {
    
    private static final int MEXP = 1279;
    ...
    private static final int MSK1 = 0xf7fefffd;
    private static final int MSK2 = 0x7fefcfff;
    private static final int MSK3 = 0xaff3ef3f;
    private static final int MSK4 = 0xb5ffff7f;
    ...
    private static final int PARITY4 = 0x20000000;
     ...
     * @throws NullPointerException if {@code jumpPoly == null}
     */
    public SFMT1279j copyAndJump(JumpPolynomial jumpPoly) {
        SFMT1279j r = new SFMT1279j(this);
        r.jump(jumpPoly);
        return r;
    }
