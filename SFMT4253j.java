 ...
 * </dl>
 */
public class SFMT4253j {
    
    private static final int MEXP = 4253;
    private static final int N = MEXP / 128 + 1;
    private static final int N32 = N * 4;
    private static final int POS1 = 17;
    private static final int SL1 = 20;
    private static final int SL2 = 1;
    private static final int SR1 = 7;
    private static final int SR2 = 1;
    private static final int MSK1 = 0x9f7bffff;
    private static final int MSK2 = 0x9fffff5f;
    private static final int MSK3 = 0x3efffffb;
    private static final int MSK4 = 0xfffff7bb;
    private static final int PARITY1 = 0xa8000001;
    private static final int PARITY2 = 0xaf5390a3;
    private static final int PARITY3 = 0xb740b3f8;
    private static final int PARITY4 = 0x6c11486d;
     ...
     * @throws NullPointerException if {@code jumpPoly == null}
     */
    public SFMT4253j copyAndJump(JumpPolynomial jumpPoly) {
        SFMT4253j r = new SFMT4253j(this);
        r.jump(jumpPoly);
        return r;
    }
